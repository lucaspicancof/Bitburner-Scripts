...
export async function main(ns) {
	...
	for (var i = 0; i < servernames.length; i++) {
		ns.tprint("==================================================");
		ns.tprint("Hack level in "+ servernames[i] + " is: " + ns.getServerRequiredHackingLevel(servernames[i]));
		ns.tprint("==================================================");
		ns.tprint(" ");
		ns.tprint("==================================================");
		ns.tprint("Ram "+ servernames[i] + " is: " + ns.getServerMaxRam(servernames[i]));
		ns.tprint("==================================================");
		ns.tprint(" ");
	}
